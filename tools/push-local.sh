#!/usr/bin/env bash
# ────────────────────────────────────────────────────────────
# push-local.sh — Build & deploy Mission: Sangreal to local Foundry VTT
# ────────────────────────────────────────────────────────────
...
MODULE_ID="neon-relic-mission-sangreal"

# ── Resolve Foundry data path ─────────────────────────────
# Priority: pathconfig file (gitignored) > default install path
...
if [[ "$DO_LINK" == true ]]; then
  ...
  echo "[push-local] Then reload the Foundry world (F5)."
  exit 0
fi
