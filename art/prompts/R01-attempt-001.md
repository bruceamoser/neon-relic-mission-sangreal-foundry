...
Image inputs: 1 is Corvi identity, 2 is Vane identity, 3 is the case design, 4 is the green pass design. Depict only the requested single gate scene. Exactly 4:3, high-mounted fixed camera, largest supported dimensions. Corvi must have a very faint, weak shadow in the puddle while the carried case has an unmistakably pitch-black shadow there. Show the railway pass protruding from his clerical coat. Black-and-white film renders its green cardstock as grey: preserve its recognizable shape and card design from the reference. Vane is small at the FAR LEFT EDGE, well behind him near the gate. Leave the lower timestamp bar blank for exact compositing. Do not enlarge the tiny pass or case plaque into readable document inserts; their lettering is not a separate local clue in this distant photograph.
