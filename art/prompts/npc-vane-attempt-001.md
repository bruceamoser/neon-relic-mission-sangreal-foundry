...
- ref-rosary-thread-sheath: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/references/ref-rosary-thread-sheath.webp

Asset prompt (verbatim): Character portrait of VANE (see reference) in a vault corridor, composed and still, hands folded over her folio; cold fluorescent lighting from above, slight vignette; expression: serene, unreadable, eyes fixed on the viewer a fraction too long.

Scene requirements: 

Mandatory visible Eggs:

- npc-vane-E1: the wooden rosary at her belt has one bead replaced with an empty needle holder (the Thread's sheath — visible on close inspection).
...
Use the attached rosary only as a prop-identity reference; preserve its hollow bead motif at her belt. Exactly one portrait, 4:5, at least 1024x1280. Frame sufficiently wide to show the belt rosary and folded hands over the slim leather folio while keeping her face prominent. Make the right-knuckle scar faint but discernible. All hair hidden by the plain black veil. No other motif objects or panels.
