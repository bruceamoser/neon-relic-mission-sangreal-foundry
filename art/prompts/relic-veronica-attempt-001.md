...
Asset prompt (verbatim): Macro photograph of a three-inch frayed linen thread, pale ochre, threaded through an unadorned silver sewing needle, laid on dark linen next to a plain wooden rosary; cold archival light.

Scene requirements: 

Mandatory visible Eggs:

- relic-veronica-E1: the thread is already frayed two-thirds through — it has been prepared for use.
