...
Medium: top-down photograph of a photocopied or carbon-copied typed document on a desk, visible grime and fingerprints, weak contrast, occasional typewriter strike-throughs, stray staple holes, leave a clean area of paper for composited text

Aspect ratio: 3:4. Minimum short edge 1024 px, prefer 1536–2048 px.
...
- ref-ubs-key-tag: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/references/ref-ubs-key-tag.webp

- ref-sonnenberg-logo: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/references/ref-sonnenberg-logo.webp

Asset prompt (verbatim): Top-down photograph of a carbon-copied bank escrow receipt on Union de Banques Suisses letterhead, faint purple carbon typing, a locker number, a telegraphic transfer amount, a small pencilled tick in the margin, folded corner, a fountain pen beside it on a leather blotter, warm lamp light, grain; leave the memo line clean for composited text.

Scene requirements: top-down carbon-leaf escrow receipt on bank stationery: locker `4409-C`, telegraphic transfer of CHF 500,000 from Sonnenberg Privatklinik to an ecclesiastical escrow account in Vaduz.

Mandatory visible Eggs:

- G03-E1: the memo line reads `Acquisition of Primary Specimen (1 of 12) — Experimental Oncology Protocol` (composite this text)

- G03-E2: a pencilled clerk's tick beside `1 of 12` — he noticed the number

- G03-E3: the carbon is slightly folded at the corner where it was kept in a jacket.
...
- Acquisition of Primary Specimen (1 of 12) — Experimental Oncology Protocol

- CHF 500,000

- Sonnenberg Privatklinik
...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/G03/attempt-001.png
Change only: Preserve the receipt exactly except two small changes: remove only the large bank-name lettering from its upper heading, leaving the crossed-keys emblem and aged paper intact for separately composited text; add the attached Sonnenberg green sun-and-mountain symbol, small, beside the blank remitter field in the upper half of the form. Do not paste the reference sheet or key tag into the scene. Preserve all blank fields, memo pencil tick, corner fold, carbon-paper texture, rules, pen and lighting. Keep 3:4 aspect.
