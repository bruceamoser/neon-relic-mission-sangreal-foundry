...
Asset prompt (verbatim): CCTV still of a vast abandoned car factory assembly hall, rain pouring through broken skylights into dark puddles, a hunched monsignor in a black cassock crossing the floor carrying a steel attaché case with taped hardware, rusted Fiat-era machinery and oil drums, burned-in camera label "6", 16mm black-and-white grain, high contrast, motion blur on the figure.

Scene requirements: the flooded assembly hall CCTV — Corvi crossing the floor with the attaché, water pouring through broken skylights.

Mandatory visible Eggs:

- T02-E1: a hairline crack in the case's deadbolt, dressed with fresh tape — the case has been under stress

- T02-E2: oil drum stencils behind him read in faded Fiat livery

- T02-E3: the puddles reflect only the lights, not Corvi's shadow — a subtle, deniable occult tell (DA's choice when to reveal).
...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/T02/attempt-001.png
Change only: Revise this standalone 4:3 monochrome factory CCTV image, keeping Corvi identity, flooded FIAT factory, no human puddle reflection, and camera 6. Correct visibility of the case clue by bringing Corvi and his steel case closer to the camera in foreground, while retaining the surrounding factory. The steel case should occupy about one quarter of image width, large enough to inspect brass combination lock hardware. On the left brass lock draw an actual narrow jagged dark crack across metal, fresh narrow tape beside it leaving the crack exposed. Small tarnished brass plaque reads SANGREAL in physically engraved capitals. FIAT drum stencils remain in background. Lock visibly damaged, not only taped. No timestamp or inset, one continuous realistic grainy surveillance frame, no giant overlaid text.
