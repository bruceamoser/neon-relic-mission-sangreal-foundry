# ref-sonnenberg-logo — Sonnenberg clinic logo
...
Asset prompt (verbatim): Single photograph of a small period-appropriate printed Sonnenberg Privatklinik logo sample on aged clinic stationery. Design proposal for human locking; the source does not specify its geometry.

Scene requirements: Single photograph of a small period-appropriate printed Sonnenberg Privatklinik logo sample on aged clinic stationery. Design proposal for human locking; the source does not specify its geometry.

Mandatory visible Eggs:

- ref-sonnenberg-logo-E1: Single photograph of a small period-appropriate printed Sonnenberg Privatklinik logo sample on aged clinic stationery. Design proposal for human locking; the source does not specify its geometry.
...
Generation framing clarification:
The clinic logo geometry is a design proposal for human reference locking. Show one small printed, restrained period clinic symbol on aged blank stationery: a simple dark-green rising sun above a low mountain contour, no words, letters, numbers or additional illustration. Photograph the paper straight overhead, one standalone photograph, no comparison variants. Landscape exactly 3:2, at least 1536x1024.
