...
Asset prompt (verbatim): 35mm flash photograph of an open wall safe hidden behind a painting of Saint Sebastian in a baroque library, the combination dial drilled cleanly at the spindle, fine metal swarf on the shelf, drawers pulled open and searched, scuff marks on the parquet, a small ladies' compact mirror half-shadowed under the desk, harsh flash, deep shadows, film grain.

Scene requirements: the open wall safe behind the Saint Sebastian painting, combination dial drilled precisely at the spindle; drawers searched but nothing taken.

Mandatory visible Eggs:

- R07-E1: the drill swarf is fine and bright — a professional tool, not a panic job

- R07-E2: a second set of scuff marks on the skirting shows someone knelt here recently and recently again

- R07-E3: a woman's compact mirror left under the desk edge (Vane searched here before the cell did).
