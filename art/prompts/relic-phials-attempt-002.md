...
- ref-phial: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/references/ref-phial.webp

Asset prompt (verbatim): Top-down forensic photograph of the open 1964 brushed-steel attaché case: molded blue velvet rack, twelve thick Roman glass phials sealed in imperial red beeswax, cursive Aramaic scratched into the glass, each holding 50 ml of dark un-coagulated blood; evidence ruler alongside, lead-antimony foil peeled back.

Scene requirements: 

Mandatory visible Eggs:

- relic-phials-E1: one rack slot is empty — the count is already eleven.
...
Prompt says twelve phials while Egg says one slot empty/count eleven. Apply user creative priority: twelve-slot rack, eleven visible phials; retain both source statements for review.
...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/relic-phials/attempt-001.png
Change only: Precise cleanup of this open case evidence photo. Preserve EXACTLY the eleven glass phials in twelve blue velvet slots, with bottom-right slot empty, SANGREAL brass plaque, case, red wax seals, incised glass, peeled metal foil at left, ruler and evidence number 1. REMOVE the ouroboros-eye emblem from INSIDE the lid, restoring plain blue velvet. REMOVE all unrelated surrounding props: green railway ticket lower left, UBS brass key tag, gold ring below case, eye-symbol card lower right and crest booklet at right. Restore plain worn wooden tabletop in those areas. Do not add any other props or symbols. Keep portrait 4:5, lighting, count and composition unchanged.
