# npc-logistics-officer — npc-logistics-officer
...
Canonical character logistics-officer: woman, 52, field jacket over a turtleneck, short cropped grey hair, a clipboard and a thermos, windburnt practical face

Reference inputs (identity/prop references, never panels or inserted pictures):

Asset prompt (verbatim): Character portrait of the COVENANT LOGISTICS OFFICER (see reference) beside a folding map table in a safehouse, a field telephone and packed crates behind her; practical lamplight.

Scene requirements: 

Mandatory visible Eggs:

- npc-logistics-officer-E1: the map has three cities ringed: Geneva, Zurich, Turin.
