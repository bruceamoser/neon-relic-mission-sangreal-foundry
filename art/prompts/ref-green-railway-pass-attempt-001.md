# ref-green-railway-pass — Green railway pass
...
Asset prompt (verbatim): Single top-down evidence photograph of a green Italian State Railways pass; leave the route line clean for exact text.

Scene requirements: Single top-down evidence photograph of a green Italian State Railways pass; leave the route line clean for exact text.

Mandatory visible Eggs:

- ref-green-railway-pass-E1: Single top-down evidence photograph of a green Italian State Railways pass; leave the route line clean for exact text.
...
- EC 30 (Romulus) — Roma Termini → Genève Cornavin
...
Show one worn green railway pass photographed flat overhead on a dark desk. Leave the central route-writing area wide, clean and blank for later exact text. No invented route, logo text, numeric codes or ticket wording. Only this pass and the evidence ruler; no other motif objects. Landscape exactly 3:2, at least 1536x1024.
