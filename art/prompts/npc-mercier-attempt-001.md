...
Asset prompt (verbatim): Character portrait of MERCIER (see reference) in a wood-paneled bank viewing booth, bank documents on the table; warm lamp, slight sweat; expression: professionally pleasant, privately terrified.

Scene requirements: 

Mandatory visible Eggs:

- npc-mercier-E1: his pocket has a carbon copy slipping out — `UBS 4409-C`.
...
The supplied brass tag establishes the code only: do not add a physical brass tag. The portrait clue is a paper carbon copy protruding from his pocket, with a blank exposed area for later text.
