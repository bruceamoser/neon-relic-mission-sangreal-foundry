...
- R09: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/src/assets/art/intel/i22-corvi-1962.webp

Asset prompt (verbatim): archival black-and-white photograph, 1964, inside a Vatican workshop: gloved hands lining a brushed-steel attaché case shell with grey metal foil, tools and clamps on the bench, a small brass plaque with one word waiting beside it, a typewritten workshop order pinned to the wall behind, high-contrast shop lighting, press grain, vignette, scratches.

Scene requirements: B/W archival photo of the attaché under construction in a Vatican workshop: gloved hands lining the shell with lead-antimony foil, the brass SANGREAL plaque on the bench beside it.

Mandatory visible Eggs:

- V04-E1: the plaque is already stamped — the name predates the case

- V04-E2: a workshop order pinned behind reads `XII phials — Gethsemane lot — destroyed if opened`

- V04-E3: the workshop supervisor's face is the young prelate from R09 — the lineage closes.
...
- XII phials — Gethsemane lot — destroyed if opened

- SANGREAL

Explicit user resolution: Match older prelate on RIGHT in approved R09, two years later in 1964. He remains an older man; disregard contradictory young-prelate wording. No red X on this workshop photograph.
