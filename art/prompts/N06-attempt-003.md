...
- npc-basarab-elder: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/src/assets/art/npc-basarab-elder.webp

- ref-basarab-crest: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/references/ref-basarab-crest.webp

Asset prompt (verbatim): Telephoto nighttime surveillance photograph through a chain-link fence of a small twin-engine 1980s aircraft on an airfield tarmac with cabin lights on and propellers turning, two figures loading a metal case through the cabin door, a tall motionless figure in a long black coat standing apart and facing the camera, hangar floods and haze, perimeter fence wire in the foreground, pushed film grain.

Scene requirements: telephoto stakeout from beyond the perimeter fence: a Cessna 421 on the tarmac, engines glowing, two figures lifting a metal case into the cabin door; hangar light spill.

Mandatory visible Eggs:

- N06-E1: the tail registration `YR-BAS`

- N06-E2: the loading crate stencil: a small dragon-wolf

- N06-E3: a third figure stands apart from the loading — tall, black-coated, face turned directly toward the camera, as if aware of the watcher (the Elder).
