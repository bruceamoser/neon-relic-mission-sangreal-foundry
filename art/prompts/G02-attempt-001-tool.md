...
Medium: passport-style frontal headshot, flat direct flash, slightly overexposed, plain institutional backdrop, 1980s passport photograph pasted onto a document, visible paper texture
...
Generation clarification: Reference image establishes Mercier's identity only; do not copy the existing pocket slip or office background. Create a top-down employee record card on a leather blotter with his pasted frontal ID photo, a clear thumbprint box, clean typed-field area, and a separate half-visible carbon telegraphic-transfer sheet beside it. Reserve a large blank stamp zone on the ID for AUTORISÉ — COFFRES and two clean carbon-copy lines for CHF 500,000 and 4409-C. Do not generate any clue wording. Keep both paper surfaces broad, unobstructed, and aligned for later perspective lettering.
