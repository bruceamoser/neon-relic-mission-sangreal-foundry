# G06 — The Swiss PTT Intercept Tape
...
- R05: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/src/assets/art/intel/i03-register-excised-card.webp

Asset prompt (verbatim): 35mm photograph of a reel-to-reel audio tape in its cardboard box on a Swiss telephone switchboard desk, a typed transcript page clipped beneath weighted by a pencil, cables and Bakelite handsets behind, cold fluorescent light, dust on the reels, film grain; leave the transcript page clean for composited text.

Scene requirements: a Swiss PTT reel-to-reel tape in its box on a switchboard desk, with a typed transcript page clipped beneath.

Mandatory visible Eggs:

- G06-E1: the transcript's final line is the "cultured voice" phone response with a Turin extension number circled

- G06-E2: a second tape box is labelled with the same hand as the transcript — and the same hand appears on the red charge card in R05 (the Watcher again).

- G06-E3: Recurring Egg-C: transcript handwriting connects to the Order; match the R05 charge-card handwriting.
...
Explicit user resolution: Use Turin extension 418, circled on transcript. Reproduce the cultured-voice response from I-8: Bring the remaining eleven vessels across the border to the Lingotto works in Turin. My house will pay triple. Do not let Rome's butchers reach you.
...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/G06/attempt-002.png
Change only: Edit image 1 only. Image 2 is handwriting-style reference ONLY: the dark calligraphic italic lettering on its red card. Change both handwritten Torino — int. 418 annotations in image1 to match that distinctive historic nib-weight and slanted calligraphic italic style, visibly same writer on transcript and second tape box. Keep exact words and numbers, circles around 418, natural material perspective and ink absorption. Do not insert the red card or any image2 objects. Preserve all typed transcript wording, PTT labels, rest of scene and lighting exactly.
