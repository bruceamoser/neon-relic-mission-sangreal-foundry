...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/G06/attempt-001.png
Change only: Precise local edit: remove the little desk calendar at extreme left that displays March 12 1987, restoring the unobtrusive desk and papers behind it. It is an invented date and should not be present. Keep every other detail exactly, especially all transcript wording, both Torino int. 418 handwritten labels and their circles, tape reels, PTT boxes, motif, handset, perspective, paper texture and light. No replacement date.
