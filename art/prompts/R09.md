...
Medium: archival black-and-white photograph, 1950s–60s press grain, slight vignette, emulsion scratches, white border with handwritten archive notation on the sleeve
...
Asset prompt (verbatim): archival black-and-white photograph, 1962, two priests at a card catalog in the Vatican Secret Archives — a young gaunt scholar and an older prelate with a signet ring, a folder with faded lettering on the table between them, press grain, vignette, emulsion scratches, a red grease-pencil X drawn over the older man's face decades later.

Scene requirements: B/W archival photo — a much younger Corvi beside an older prelate at the Secret Archives, both in cassocks, both holding catalog cards.

Mandatory visible Eggs:

- R09-E1: the older prelate wears the ouroboros-eye ring (the lineage of watchers inside the Vatican)

- R09-E2: on the table between them lies a folder marked `XII-SANG`

- R09-E3: someone has drawn a red X over the prelate's face since.
...
Explicit user resolution: R08 depicts present-day Corvi age 58. R09 depicts Corvi in 1962 age approximately 33, retaining identity, in a different photo session. Same dark tie with narrow diagonal pale stripes appears in both. This supersedes same-session wording. R09 retains its explicitly older prelate; V04 age wording remains separately unresolved.
