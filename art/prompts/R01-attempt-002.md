...
- ref-green-railway-pass: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/references/ref-green-railway-pass.webp

Asset prompt (verbatim): CCTV still, high mounted gate camera looking down at the Porta Sant'Anna arch in Vatican City at night, a lone monsignor in a black cassock walks out carrying a heavy steel attaché case, single lamp above the arch, wet cobblestones with puddles, a nun's figure at the far left edge of frame, heavy grain, timestamp bar burned into the lower corner reading "03:14 17-IX-87", 16mm surveillance film, black and white, high contrast.

Scene requirements: the Porta Sant'Anna gate, 03:14 AM. Corvi exits on foot carrying the attaché, backlit by a single lamp above the arch.

Mandatory visible Eggs:

- R01-E1: in the puddle, Corvi casts a faint shadow but the case casts a pitch-black one

- R01-E2: the green railway pass protrudes from his coat

- R01-E3: at the far left, half out of frame, a nun's veil catches the light — Vane, forty metres behind

- R01-E4: timestamp `03:14 17-IX-87` in the burned-in clock bar.
...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/R01/attempt-001.png
Change only: Preserve the entire gate scene and identities. Change only three local details: (1) make the long human-shaped shadow cast by Corvi onto the puddle extremely faint and translucent, nearly absent; retain a separate unmistakably pitch-black, solid case-shaped shadow directly below the carried case. The case shadow must be dramatically darker than the human shadow. (2) tuck the lower half of the small railway card into an actual coat pocket, leaving its upper half protruding visibly. (3) move the distant nun slightly left so part of her robe is cut by the left frame edge while her veil still catches light. Preserve Corvi, his case, the lamp, arch, cobbles, monochrome film style and blank timestamp strip. Exactly 4:3.
