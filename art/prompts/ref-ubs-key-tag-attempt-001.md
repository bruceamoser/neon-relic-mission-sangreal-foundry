# ref-ubs-key-tag — Locker key tag
...
Asset prompt (verbatim): Single macro evidence photograph of a brass locker key tag; reserve the stamping area for compositing.

Scene requirements: Single macro evidence photograph of a brass locker key tag; reserve the stamping area for compositing.

Mandatory visible Eggs:

- ref-ubs-key-tag-E1: Single macro evidence photograph of a brass locker key tag; reserve the stamping area for compositing.
...
Show one tarnished rectangular brass locker key tag with rounded corners and a small key ring on an evidence table, nearly flat top-down so the broad central engraving area is clean and blank. Exact text added separately. No other motif objects. Landscape exactly 3:2, at least 1536x1024.
