# ref-rosary-thread-sheath — Vane rosary
...
Asset prompt (verbatim): Single macro photograph of the plain wooden rosary with one bead an empty needle holder. Establish the intact sheath used by Vane, not a collection of alternate states.

Scene requirements: Single macro photograph of the plain wooden rosary with one bead an empty needle holder. Establish the intact sheath used by Vane, not a collection of alternate states.

Mandatory visible Eggs:

- ref-rosary-thread-sheath-E1: Single macro photograph of the plain wooden rosary with one bead an empty needle holder. Establish the intact sheath used by Vane, not a collection of alternate states.
...
Single close-up of the plain wooden rosary. One bead incorporates the tiny empty needle-holder aperture, visibly hollow on close inspection; show this intact bead with its opening visible, not a split bead or extra view. No needle, no thread protruding, no text. No other motif objects. Landscape exactly 3:2, at least 1536x1024.
