...
Asset prompt (verbatim): 35mm photograph of a dented grey metal cargo crate on an airfield tarmac after partial unloading, stencilled lettering partly chalked over, a stencilled dragon-wolf crest, customs security ties intact, older stencilled lettering faintly showing through the paint, wet concrete, sodium lights, film grain; leave the stencil areas clean for composited text.

Scene requirements: the metal cargo crate photographed after a partial unload: stencil marks, chalk manifest numbers, customs ties.

Mandatory visible Eggs:

- V05-E1: the crate carries the dragon-wolf stencil and `BASARAB HOLDINGS S.A.` stencilled letters

- V05-E2: the chalk tally reads `10/12` — two phials unaccounted for before the aircraft even leaves Europe

- V05-E3: a customs tie is intact but a second, older mark beneath the stencil shows through: `VATICAN MUSEUMS — storeroom 9` — the crate was in the Vatican before it was in Romania.

- V05-E4: Recurring Egg-H: white calcified ash visible in sealed crate refuse.
...
- BASARAB HOLDINGS S.A.

- 10/12

- VATICAN MUSEUMS — storeroom 9

Production interpretation notes:

Recurring Egg-H additionally requires white calcified ash in sealed crate refuse.
