...
EDIT TARGET: /mnt/disk4/repos/neon-relic-mission-sangreal-foundry/art/work/R01/attempt-002.png
Change only: Correct ONLY the tiny badge-like rectangle on Corvis coat. Remove its badge appearance. At that same spot, add a clearly visible horizontal black breast-pocket opening and tuck the lower half of a small railway pass behind that pocket fabric; the upper half protrudes at a slight angle, with its top paper edge visibly lifted from the coat and a thin shadow. The card must unmistakably emerge from an actual pocket, not be pinned or pasted flat on the coat. All other pixels and details are invariants, especially the faint human shadow, pitch-black case shadow, partly cropped Vane at far left, Corvis identity, case, gate, lighting and timestamp area. One 4:3 frame.
