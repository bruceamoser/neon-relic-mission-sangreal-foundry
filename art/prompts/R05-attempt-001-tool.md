# R05 — The Excised Codex Register
...
Asset prompt (verbatim): Top-down photograph of an open mahogany card-catalog drawer in a Vatican archive, one index card removed leaving a clean scalpel-cut stub, in its place a single red card; surrounding cards dusty, faint overhead archive lamp, aged paper textures, shallow depth of field, film grain; leave the red card's centre clean for composited Latin text.

Scene requirements: the mahogany catalog drawer in the Archivio Segreto; one index card excised with a scalpel; in its place a red charge card in Latin cursive.

Mandatory visible Eggs:

- R05-E1: the excised stub shows the shelf-mark `MS-Vat-Heb-418`

- R05-E2: the red card reads `Extractum per Breve Apostolicum — Anno Domini 1582 — Ad Capsam XII-SANG-00` (composite this text)

- R05-E3: dust has settled on the surrounding cards but not on the red one — it was placed recently.
...
- Extractum per Breve Apostolicum — Anno Domini 1582 — Ad Capsam XII-SANG-00
...
Generation clarification: Use asset-specific open drawer scene, not a flat document. Red charge card lies tilted toward camera with large blank readable face. Exposed scalpel-cut pale stub immediately in front, wide enough for shelf-mark later. Thick dust on surrounding cards and entirely clean red card. Leave both clue text areas blank.
